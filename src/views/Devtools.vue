  ...
  data() {
    return {
      pages: [
        ...
        { id: 5, title: 'BabylonJS-VR', subtitle: 'Babylon.js is a powerful open-source 3D graphics engine that enables developers to create high-quality, interactive 3D experiences on the web. It has robust features for building immersive experiences in a webXR context.', starter: 'https://doc.babylonjs.com/features/featuresDeepDive/webXR', website: 'https://www.babylonjs.com/' },
        { id: 5, title: 'model-viewer', subtitle: 'Google Model Viewer is a web-based tool for rendering interactive 3D models in a webXR context, allowing users to view and manipulate objects in a web browser with augmented reality (AR) and virtual reality (VR) capabilities.', starter: 'https://modelviewer.dev/editor/', website: 'https://modelviewer.dev/' },
      ],
      window: {
        width: 0,
      }
